...
//       {editing ? (
//         <>
//           <input value={title} onChange={e=>setTitle(e.target.value)} className="w-full p-1 border rounded mb-2" />
//           <textarea value={content} onChange={e=>setContent(e.target.value)} className="w-full p-1 border rounded mb-2" />
//           <div className="flex gap-2">
//             <button onClick={save} className="px-2 py-1 bg-sky-600 text-white rounded">Save</button>
//             <button onClick={()=>setEditing(false)} className="px-2 py-1 border rounded">Cancel</button>
//             <button onClick={onDelete} className="ml-auto px-2 py-1 text-red-600">Delete</button>
//           </div>
//         </>
//       ) : (
//         <>
